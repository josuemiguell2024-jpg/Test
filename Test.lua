...
gui.Name="EnvyAutoBatDesyncGUI"; gui.ResetOnSpawn=false; gui.DisplayOrder=10
...
titleLbl.BackgroundTransparency=1; titleLbl.Text="ARA ANTI DESYNC"
...
print("[Ara Auto Bat Desync] Loaded!")
